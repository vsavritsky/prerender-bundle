...
namespace Vsavritsky\PrerenderBundle\Tests\Listener;

use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpKernel\Event\GetResponseEvent;
use Symfony\Component\HttpKernel\HttpKernelInterface;
use Vsavritsky\PrerenderBundle\Listener\KernelListener;
...
class KernelListenerTest extends TestCase
{
    ...
    public function testOnKernelRequest(
        ...
        $httpClient = $this->createMock(\Vsavritsky\PrerenderBundle\HttpClient\ClientInterface::class);
